...
metinler o sınıra göre yazıldı, hepsi tek ekranda okunuyor.

**Kullanım:** Fiyat sorusuna doğrudan cevap ver. "DM'den yazalım" deyip oyalamak
güveni kırıyor. Net rakam ver, PDF ekle, kapıyı açık bırak.

**Fiyat değişirse hem burayı hem Meta'daki otomasyonu güncelle.**

---

## Otomatik yanıt tetikleyicileri

| Otomasyon | Anahtar kelimeler | PDF |
|---|---|---|
| 1 – English Drama Lab | `1` · `drama lab` · `english drama` | /dosyalar/edl.pdf |
| 2 – English Acting Praxis | `2` · `acting praxis` · `ingilizce oyunculuk` | /dosyalar/praxis.pdf |
| 3 – English Drama Youth | `3` · `youth` · `çocuk` | /dosyalar/youth.pdf |
| 4 – Techne Musical Lab | `4` · `musical lab` · `müzikal` | /dosyalar/musical.pdf |
| 5 – Broadway Musical Dance | `5` · `broadway` · `dans` | /dosyalar/broadway.pdf |
| 6 – The Auteur Lab | `6` · `auteur` · `yazarlık` | /dosyalar/auteur.pdf |

Meta'nın kuralı: eşleşme tam olmalı, ve otomatik yanıt sohbet 15 dakikadır
sessizse gider. Bu sistem seni ikame etmiyor, sen meşgulken devreye giriyor.
...
Program 3 Ekim'de başlıyor · 14 kişilik grup

Başvuru için kısa bir özgeçmiş ve 1 dakikalık İngilizce video yeterli.
```

---

## 3 · ENGLISH DRAMA YOUTH (10–17)

*Veliye yazılıyor.*

```
English Drama Youth — 10–17 yaş, tamamen İngilizce.
...
```
The Auteur Lab — yaratıcı yazarlık ve dramaturji, Kadıköy.
...
## Icebreaker (80 karakter)

- `Hangi program için bakıyorsunuz? Yetişkin mi, 10–17 yaş mı?`
- `Ücretsiz tanışma atölyesi 12, 13 ve 19 Eylül. Detay göndereyim mi?`

## Sabitlenecek ilk yorum

Yetişkin misiniz, çocuğunuz için mi bakıyorsunuz? İkisi de var. Seviye testi yok,
B1 ve üzeri yeterli · gruplar en fazla 12 kişi · adres kayıt sonrası iletiliyor.

---

Kurallar: "ders" yok · postta telefon yok · eğitmen adı yalnızca gerekli yerde ·
tarihler `sessions.ts` ile eşit.
