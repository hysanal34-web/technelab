...
export const metadata: Metadata = {
  ...
  description:
    'Techne Lab ücretsiz tanışma günü kayıt formu: English Drama Lab, English Acting Praxis, Broadway Musical Dance ve Techne Musical Lab — Taksim Pera 19 Eylül · English Drama Youth — Kadıköy 27 Eylül.',
