...
Kelime moda olduğu için üç ayrı şeyin yerine kullanılıyor. Ayrımlar pratikte önemli.

**Lidersizlik değil.** Ensemble, karar alınmayan bir oda anlamına gelmiyor. Bir önceki bölümde anlatılan şey tam da bu: karar var, ama gerekçesiyle ve görünür biçimde veriliyor. Kimsenin karar vermediği topluluklar, demokratik değil; sadece yavaş ve genellikle dağılıyorlar.

**Devising ile aynı şey değil.** Devising bir metin üretme yöntemi — oyun, hazır bir metinden değil, odadaki malzemeden çıkıyor. Ensemble ise bir çalışma ilişkisi. Bir topluluk Shakespeare oynayarak da ensemble olabilir; devising yapan bir grup ise pekâlâ tek bir kişinin yönlendirmesinde, hiyerarşik çalışıyor olabilir. İkisi sık sık bir arada bulunuyor ama biri diğerini gerektirmiyor.

**Kadro sürekliliği tek başına yetmiyor.** Aynı on kişiyle on yıl çalışmak ensemble üretmiyor; alışkanlık üretiyor. Uzun süredir birlikte çalışan bazı topluluklar, tam da bu yüzden en katı hiyerarşilere sahip. Belirleyici olan kadronun sabitliği değil, önerinin odada nasıl dolaştığı.

**Arkadaşlık değil.** İyi anlaşan bir grup, otomatik olarak iyi bir ensemble değil — bazen tersi. Çatışmadan kaçınan topluluklar, sahneye dair zor soruları da sormuyorlar. Ensemble'ın gerektirdiği şey yakınlık değil, güven: fikrin reddedilmesinin kişinin reddedilmesi anlamına gelmediğine dair ortak bir zemin.

## — Ne zaman çalışmıyor

Dürüst olmak gerekirse ensemble her koşulda doğru cevap değil.

**Kısa süreli prodüksiyonlarda pahalı.** Üç haftada sahnelenecek bir iş, kolektif arayışın zamanını taşımıyor. Böyle durumlarda dikey prova yalnızca meşru değil, daha dürüst.

**Deneyim farkı çok açıldığında zorlanıyor.** Odadaki kişilerin bir kısmı sahneyi hiç görmemişse, "herkes öneri yapar" ilkesi pratikte deneyimlilerin önerilerinin geçtiği bir düzene dönüşüyor — üstelik bu kez adı konmamış bir hiyerarşiyle. Açık hiyerarşi, gizli olandan daha iyi çalışıyor.

**Düzenlilik olmadan kurulmuyor.** Haftada bir buluşan ama her seferinde yarısı eksik olan bir grup ensemble olamıyor. Ortak beden, devamlılıkla kuruluyor.
