...
Süre sorusunun altında gizlenen asıl soru bu. Bir metnin bittiğini nasıl anlarsın?

Kesin bir eşik yok ama işe yarayan birkaç ölçüt var.

**Her sahneye isim verebiliyorsan.** Sahne sahne tek cümlelik bir başlık yazabiliyorsan — "kardeş parayı ister", "anne yalanı sürdürür" — yapı oturmuş demektir. İsimlendirilemeyen sahne, henüz çözülmemiş sahnedir.

**Kesme kararların kolaylaştığında.** Yazma sürecinin başında her cümle değerli görünür. Metin olgunlaştıkça hangi sahnenin taşıyıcı, hangisinin süs olduğu netleşir ve kesmek acıtmaz olur. Bu his, yapısal netliğin en güvenilir göstergesi.

**Revizyonlar küçüldüğünde.** Her turda değiştirdiğin şey sahne sırasından replik seçimine, oradan noktalama işaretine kaydıysa metin bitmiş, sen bırakamamışsındır. Sonsuz cila, bitirmemenin en kibar biçimi.

**Sesli okuma seni şaşırtmadığında.** İlk okumalarda metin sürekli sürpriz üretir — beklenmedik yerde uzar, beklenmedik yerde düşer. Okuma seni artık şaşırtmıyorsa metin oturmuştur.

Bitirmenin en zor tarafı şu: bir oyun asla "hazır" hissettirmez. Sahnelenmiş, basılmış, yıllar önce bitmiş oyunlarını okuyan yazarların çoğu hâlâ değiştirecek yer buluyor. Ölçüt mükemmellik değil, metnin başka insanların eline geçmeye dayanacak kadar sağlam olması. Bir oyun zaten prova odasında tamamlanıyor — yazarın masasında değil.

## İkinci oyun neden farklı geçiyor?

Yukarıdaki takvim ilk oyun içindir. İkincisi genellikle daha kolay değil, farklı zor.

İlk oyunda biriktirilmiş bir şey vardır — yıllardır anlatmak istenen konu, tanıdık bir dünya, hazır bir öfke. İkinci oyunda o rezerv tükenmiştir ve konu bilinçli olarak seçilmek zorundadır. Pek çok yazarın "ikinci oyun tıkanması" dediği şey yetenek kaybı değil, malzeme kaynağının değişmesidir.

Buna karşılık teknik taraf hızlanır: yapıyı kurmak, sahne kesmek, sesli okumadan not çıkarmak artık öğrenilmiş işlerdir. Yani ikinci oyunda yapısal aşamalar kısalır, fikir aşaması uzar. Toplam süre çoğu zaman benzer kalır — sadece zorluk yer değiştirir.
